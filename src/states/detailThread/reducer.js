...
const threadDetailReducer = (threadDetail = null, action = {}) => {
  switch (action.type) {
    ...
    case ActionType.TOGGLE_UP_VOTE_TREAD_DETAIL:
      return {
        ...threadDetail,
    ...
    case ActionType.TOGGLE_DOWN_VOTE_TREAD_DETAIL:
      return {
        ...threadDetail,
        downVotesBy: threadDetail.downVotesBy.includes(action.payload.userId)
          ? threadDetail.downVotesBy.filter((id) => id !== action.payload.userId)
    ...
    case ActionType.TOGGLE_NEUTRALIZE_UP_VOTE_TREAD_DETAIL:
      return {
        ...threadDetail,
        downVotesBy: threadDetail.downVotesBy.includes(action.payload.userId)
          ? threadDetail.downVotesBy.filter((id) => id !== action.payload.userId)
    ...
    case ActionType.TOGGLE_NEUTRALIZE_DOWN_VOTE_TREAD_DETAIL:
      return {
        ...threadDetail,
        downVotesBy:
    ...
    case ActionType.TOGGLE_NETRALIZE_COMMENT:
      return {
        ...threadDetail,
        comments: threadDetail.comments.map((comment) => {
          if (comment.id === action.payload.commentId) {
