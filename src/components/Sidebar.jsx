...
function Sidebar() {
  return (
    ...
    <div className="flex flex-col w-1/4 h-full justify-start items-start px-10 bg-white">
      ...
      <h1 className="text-xl flex flex-row cursor-pointer rounded-full p-3 hover:bg-slate-200"><MdOutlineLeaderboard className="mr-4" /><Link to="/">LeaderBoards</Link> </h1>
      ...
      <h1 className="text-lg cursor-pointer py-3 px-5 bg-blue-500 text-white border-2 rounded-full ml-2 hover:bg-blue-600"><Link to="/">Buat diskusi</Link></h1>
    </div>
  );
}
